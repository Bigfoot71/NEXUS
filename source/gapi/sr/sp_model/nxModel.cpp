...
void _sr_impl::Model::Draw(const math::Vec3& position, const math::Vec3& rotationAxis, float rotationAngle, const math::Vec3& scale, const gfx::Color& tint)
{
...
void _sr_impl::Model::Draw(const math::Vec3& position, float scale, const gfx::Color& tint)
{
    Draw(position, { 0.0f, 1.0f, 0.0f }, 0.0f, { scale, scale, scale }, tint);
}

void _sr_impl::Model::DrawWires(const math::Vec3& position, float scale, const gfx::Color& tint)
{
    ctx.EnableWireMode();
...
void _sr_impl::Model::DrawWires(const math::Vec3& position, const math::Vec3& rotationAxis, float rotationAngle, const math::Vec3& scale, const gfx::Color& tint)
{
    ctx.EnableWireMode();
